...
import type { Region } from "./locations.ts";
import type { Move, MoveLearnMethod } from "./moves.ts";
import type { Ability, PokemonSpecies, Type } from "./pokemon.ts";
import type { Description, Name, NamedAPIResource } from "./utility.ts";
