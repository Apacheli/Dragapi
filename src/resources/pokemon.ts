...
import type { LocationArea, PalParkArea } from "./locations.ts";
import type {
  Move,
  MoveBattleStyle,
  MoveDamageClass,
...
export interface PokemonForm {
  ...
  types: NamedAPIResource<PokemonFormType>;
...
export interface Type {
  ...
  damage_relations: TypeRelations<Type>;
  /** A list of details of how effective this type was toward others and vice versa in previous generations */
  past_damage_relations: TypeRelationsPast<Type>[];
...
export interface TypeRelations<T> {
...
export interface TypeRelationsPast<T> {
